...
| `MULTICA_BIND_ADDRESS` | `127.0.0.1` | Docker self-host bind address for published frontend/backend ports. Use `0.0.0.0` only for trusted LAN testing; prefer a reverse proxy for public deployments |
