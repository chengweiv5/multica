...
func TestFlattenInteractiveContent_LinkShareCard(t *testing.T) {
	t.Parallel()
	raw := `{"title":"Harness 工程之道：Skill 原理与最佳实践","card_link":{"url":"https://m.toutiao.com/article/7659345418668474895/","android_url":"","ios_url":"","pc_url":""},"elements":[]}`
	want := "Harness 工程之道：Skill 原理与最佳实践 (https://m.toutiao.com/article/7659345418668474895/)"
