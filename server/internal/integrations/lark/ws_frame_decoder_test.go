...
func TestLarkJSONFrameDecoderInteractiveCardFlattened(t *testing.T) {
	t.Parallel()
	cardContent := `{"title":"Harness 工程之道","card_link":{"url":"https://m.toutiao.com/article/7659345418668474895/"},"elements":[]}`
	...
	want := "Harness 工程之道 (https://m.toutiao.com/article/7659345418668474895/)"
	if msg.Body != want {
		t.Errorf("Body = %q; want %q", msg.Body, want)
	}
